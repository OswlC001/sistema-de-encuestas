...
//        doBeforeProcessing(request, response);
        ...
        try {
            ...
            if (httpRequest.getServletPath().equals("/login.xhtml") || httpRequest.getServletPath().contains("/javax.faces.resource")) {
                chain.doFilter(request, response);
            } else {
                Boolean loggedIn = (Boolean) session.getAttribute("loggedIn");
                if (loggedIn == null || filterConfig == null || loggedIn==false) {
