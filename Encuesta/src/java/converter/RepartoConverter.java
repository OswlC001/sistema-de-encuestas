...
import sessionBeans.RepartoFacade;
...
@FacesConverter(value = "repartoConverter")
public class RepartoConverter implements Converter {

    @Inject
    private RepartoFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Reparto) {
            ...
            return getStringKey(o.getRepaCodigo2());
        } else {
